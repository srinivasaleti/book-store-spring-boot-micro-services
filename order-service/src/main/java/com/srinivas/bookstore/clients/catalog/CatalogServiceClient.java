...
public class CatalogServiceClient {
  ...
  public Optional<Product> getProductByCode(String code) {
    logger.info(
        "Fetching product by productCode", StructuredArguments.keyValue("product_code", code));
    Product product =
  ...
  public Optional<Product> getProductByCodeFallbackMethod(String code, Throwable throwable) {
    logger.info(
        "getProductByCodeFallbackMethod", StructuredArguments.keyValue("product_code", code));
    return Optional.empty();
  }

  public Optional<Product> getProductByCodeCircuitBreakerFallbackMethod(
      String code, Throwable throwable) {
    logger.info(
        "getProductByCodeCircuitBreakerFallbackMethod",
        StructuredArguments.keyValue("product_code", code));
    return Optional.empty();
  }
}
